...
INSERT INTO flights (flight_id, airline, flight_number, direction, arrival_time, airport, terminal) VALUES
  ('fl000001-0000-0000-0000-000000000001', 'Air China',   'CA 988',  'arrival', '2027-06-15T10:30:00Z', 'PEK-T3', 'T3'),
  ('fl000002-0000-0000-0000-000000000002', 'Delta',       'DL 189',  'arrival', '2027-06-15T14:10:00Z', 'PEK-T2', 'T2'),
  ('fl000003-0000-0000-0000-000000000003', 'Air China',   'CA 986',  'arrival', '2027-06-15T17:20:00Z', 'PEK-T3', 'T3'),
  ('fl000004-0000-0000-0000-000000000004', 'United',      'UA 89',   'arrival', '2027-06-15T18:45:00Z', 'PEK-T3', 'T3'),
  ('fl000005-0000-0000-0000-000000000005', 'Air Canada',  'AC 61',   'arrival', '2027-06-14T17:30:00Z', 'PEK-T3', 'T3'),
  ('fl000006-0000-0000-0000-000000000006', 'Air Canada',  'AC 63',   'arrival', '2027-06-15T16:05:00Z', 'PEK-T3', 'T3');

-- Departure flights
INSERT INTO flights (flight_id, airline, flight_number, direction, departure_time, airport, terminal) VALUES
  ('fl100001-0000-0000-0000-000000000001', 'Air China',   'CA 989',  'departure', '2027-06-20T20:45:00Z', 'PEK-T3', 'T3'),
  ('fl100002-0000-0000-0000-000000000002', 'Delta',       'DL 188',  'departure', '2027-06-20T16:25:00Z', 'PEK-T2', 'T2'),
  ('fl100003-0000-0000-0000-000000000003', 'Air China',   'CA 987',  'departure', '2027-06-20T18:45:00Z', 'PEK-T3', 'T3'),
  ('fl100004-0000-0000-0000-000000000004', 'Air Canada',  'AC 64',   'departure', '2027-06-20T17:45:00Z', 'PEK-T3', 'T3'),
  ('fl100005-0000-0000-0000-000000000005', 'Korean Air',  'KE 719',  'departure', '2027-06-20T20:30:00Z', 'PEK-T2', 'T2'),
  ('fl100006-0000-0000-0000-000000000006', 'Air Canada',  'AC 62',   'departure', '2027-06-20T19:05:00Z', 'PEK-T3', 'T3');
...
INSERT INTO traveler_flights (traveler_id, flight_id, direction, flight_submitted, submit_option) VALUES
  ('f0000001-0000-0000-0000-000000000001', 'fl000004-0000-0000-0000-000000000004', 'arrival', true, 'Invitee'),
  ('f0000002-0000-0000-0000-000000000002', 'fl000002-0000-0000-0000-000000000002', 'arrival', true, 'Invitee'),
  ('f0000003-0000-0000-0000-000000000003', 'fl000002-0000-0000-0000-000000000002', 'arrival', true, 'Submit now'),
  ('f0000004-0000-0000-0000-000000000004', 'fl000003-0000-0000-0000-000000000003', 'arrival', true, 'Invitee'),
  ('f0000005-0000-0000-0000-000000000005', 'fl000003-0000-0000-0000-000000000003', 'arrival', true, 'Same as Main Passenger'),
  ('f0000006-0000-0000-0000-000000000006', 'fl000004-0000-0000-0000-000000000004', 'arrival', true, 'Invitee'),
  ('f0000007-0000-0000-0000-000000000007', 'fl000005-0000-0000-0000-000000000005', 'arrival', true, 'Submit now'),
  ('f0000008-0000-0000-0000-000000000008', 'fl000004-0000-0000-0000-000000000004', 'arrival', true, 'Invitee'),
  ('f0000009-0000-0000-0000-000000000009', 'fl000004-0000-0000-0000-000000000004', 'arrival', true, 'Submit now'),
  ('f0000010-0000-0000-0000-000000000010', 'fl000006-0000-0000-0000-000000000006', 'arrival', true, 'Invitee');

-- Traveler-Flight assignments (departure)
INSERT INTO traveler_flights (traveler_id, flight_id, direction, flight_submitted, submit_option) VALUES
  ('f0000001-0000-0000-0000-000000000001', 'fl100001-0000-0000-0000-000000000001', 'departure', true, 'Invitee'),
  ('f0000002-0000-0000-0000-000000000002', 'fl100002-0000-0000-0000-000000000002', 'departure', true, 'Invitee'),
  ('f0000003-0000-0000-0000-000000000003', 'fl100002-0000-0000-0000-000000000002', 'departure', true, 'Submit now'),
  ('f0000004-0000-0000-0000-000000000004', 'fl100003-0000-0000-0000-000000000003', 'departure', true, 'Invitee'),
  ('f0000005-0000-0000-0000-000000000005', 'fl100003-0000-0000-0000-000000000003', 'departure', true, 'Same as Main Passenger'),
  ('f0000006-0000-0000-0000-000000000006', 'fl100004-0000-0000-0000-000000000004', 'departure', true, 'Invitee'),
  ('f0000007-0000-0000-0000-000000000007', 'fl100005-0000-0000-0000-000000000005', 'departure', true, 'Submit now'),
  ('f0000008-0000-0000-0000-000000000008', 'fl100004-0000-0000-0000-000000000004', 'departure', true, 'Invitee'),
  ('f0000009-0000-0000-0000-000000000009', 'fl100004-0000-0000-0000-000000000004', 'departure', false, 'Submit now'),
  ('f0000010-0000-0000-0000-000000000010', 'fl100006-0000-0000-0000-000000000006', 'departure', true, 'Invitee');
...
INSERT INTO notifications (notification_id, title, body, target_type, published_at, created_by) VALUES
  ('n0000001-0000-0000-0000-000000000001', 'Welcome to WSB 2027 China! 🇨🇳', 'We are thrilled to have you join us for an unforgettable journey through Beijing. Your digital companion is ready — check your itinerary, QR code, and toolkit!', 'all', '2027-06-14T12:00:00Z', 'f0000012-0000-0000-0000-000000000012'),
  ('n0000002-0000-0000-0000-000000000002', 'Bus Assignment Ready 🚌', 'Your airport transfer bus has been assigned. Check your itinerary for bus number and departure time.', 'all', '2027-06-14T18:00:00Z', 'f0000012-0000-0000-0000-000000000012'),
  ('n0000003-0000-0000-0000-000000000003', 'Welcome Dinner Tonight! 🍽️', 'Reminder: Welcome Dinner & Cultural Show at The Ritz-Carlton Grand Ballroom at 7:00 PM. Dress code: smart casual.', 'all', '2027-06-15T15:00:00Z', 'f0000012-0000-0000-0000-000000000012');

INSERT INTO traveler_notifications (traveler_id, notification_id) VALUES
  ('f0000001-0000-0000-0000-000000000001', 'n0000001-0000-0000-0000-000000000001'),
  ('f0000001-0000-0000-0000-000000000001', 'n0000002-0000-0000-0000-000000000002'),
  ('f0000001-0000-0000-0000-000000000001', 'n0000003-0000-0000-0000-000000000003'),
  ('f0000002-0000-0000-0000-000000000002', 'n0000001-0000-0000-0000-000000000001'),
  ('f0000002-0000-0000-0000-000000000002', 'n0000002-0000-0000-0000-000000000002'),
  ('f0000004-0000-0000-0000-000000000004', 'n0000001-0000-0000-0000-000000000001'),
  ('f0000006-0000-0000-0000-000000000006', 'n0000001-0000-0000-0000-000000000001'),
  ('f0000006-0000-0000-0000-000000000006', 'n0000002-0000-0000-0000-000000000002'),
  ('f0000008-0000-0000-0000-000000000008', 'n0000001-0000-0000-0000-000000000001'),
  ('f0000010-0000-0000-0000-000000000010', 'n0000001-0000-0000-0000-000000000001'),
  ('f0000010-0000-0000-0000-000000000010', 'n0000002-0000-0000-0000-000000000002');
